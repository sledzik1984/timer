    ...
    TimeWidget(QTime(0, 0), std::move(color), parent)
{
    ...
    connect(this, &ClockWidget::hours_long_pressed  , this, &ClockWidget::reset);

    connect(this, &ClockWidget::minutes_clicked, [this](){ add_offset(  60); });
    connect(this, &ClockWidget::minutes_long_pressed, this, &ClockWidget::reset);

    connect(this, &ClockWidget::seconds_clicked, [this](){ add_offset(   1); });
    connect(this, &ClockWidget::seconds_long_pressed, this, &ClockWidget::reset);
